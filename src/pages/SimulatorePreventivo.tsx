      ...
      <div className="min-h-screen bg-[#0d0d1a] flex items-center justify-center px-4">
        <div className="text-center max-w-lg">
          ...
          <p className="text-gray-400 leading-relaxed mb-6">
            Ti ho riservato l'<strong className="text-white">ultimo posto disponibile</strong> di Aprile. Riceverai un messaggio WhatsApp da me entro 2 ore con il preventivo dettagliato e la promo –30% già applicata.
          </p>
  ...
  return (
    <>
      <SEO
        ...
        description="Scopri il costo del tuo sito web professionale. Configura template, chatbot AI e moduli. Promo Pasqua –30%. Ultimo posto disponibile."
        canonical="https://www.mauroceccarelli.it/simulatore"
        ...
        <div className="relative z-10 lg:flex lg:min-h-screen">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-red-500/40 bg-red-500/10 text-red-400 text-sm font-bold mb-5">
              ...
              ⚡ Ultimo posto disponibile ad Aprile — promo –30% in scadenza
            </div>
          ...
          <div className="hidden lg:block fixed top-0 right-0 h-screen w-[300px] xl:w-[340px] overflow-y-auto border-l border-white/10 bg-[#0d0d1a] px-5 py-8 z-20">
              <div className="mb-4 p-3 rounded-xl bg-gradient-to-r from-orange-500/15 to-red-500/15 border border-orange-500/25 flex items-start gap-2">
                ...
                <p className="text-xs font-bold text-orange-300 leading-snug">⚡ PROMO PASQUA –30% APPLICATA.<br />ULTIMO POSTO DISPONIBILE AD APRILE.</p>
              </div>
