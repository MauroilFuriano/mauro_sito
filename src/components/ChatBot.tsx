  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 left-4 lg:bottom-8 lg:left-8 z-50 w-16 h-16 rounded-full bg-dark-800 border-2 border-cyan-400 flex items-center justify-center shadow-lg hover:shadow-[0_0_30px_rgba(0,229,255,0.5)] transition-all duration-300 group ${isOpen ? 'scale-0 opacity-0' : 'scale-100 opacity-100'}`}
      ...
      <div
        className={`fixed bottom-6 left-4 lg:bottom-8 lg:left-8 z-50 w-[380px] max-w-[calc(100vw-2rem)] transition-all duration-300 ${
